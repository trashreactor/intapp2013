<%@include file='master/header.jsp'%>
    <div id="divContenedor">
        ...
        <div id="divBusqueda">
            Buscador por Nombre o Código<br />
                ...
                <table class="highLightRow" cellpadding="3" cellspacing="0" border="1" width="1000">
                    ...
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Image1" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img1" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img3" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img13" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img17" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img19" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img21" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img23" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img25" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">
                            <a href="?a=edit&id=">
                                <img id="Img27" src="img/tick.png" alt="Modificar" border="0" />
                            </a>
                        </td>
                    </tr>
                </table>
