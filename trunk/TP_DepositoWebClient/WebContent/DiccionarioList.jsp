...
<% String divEditar =(request.getParameter("divEditar")==null)?"0":(String)request.getParameter("divEditar");%>
<% String id = (String)request.getParameter("id"); %>
<% String eliminar =(request.getParameter("eliminar")==null)?"0":(String)request.getParameter("eliminar");%>
<%	Sistema s = Sistema.getInstancia(); %>
<%  String idDicc =(request.getParameter("idDicc")==null)?(String)session.getAttribute("idDicc"):(String)request.getParameter("idDicc");%>
<% 	session.setAttribute("idDicc", idDicc); %>
<%
	if(eliminar.equals("1")){
		DiccionarioView dView = s.buscarDiccionarioViewByID(Long.parseLong(id));
		List<ItemDiccionario> items = s.buscarDiccionarioByID(dView.getIdDiccionario()).getItemsDiccionario();
		if(items.isEmpty()){
...
function ValidaCreacion( DiccionarioList ) {
	  if (DiccionarioList.tNombre.value != null && DiccionarioList.tDescripcion.value != null) {
	    return true
	  } else {
	    return false
	  }
    ...
    <div id="divContenedor">
        ...
        <div id="divBusqueda">
            <div id="divFiltros">
                <table style="width: 100%;">
                    <tr>
                        <td>
                            <input name="tBuscar" type="text" value="nombre diccionario" />
                            <input name="action" type="submit" value="Buscar" onclick="alert('Funcionalidad no implementada');"/>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="divListado">
            ...
            <div style="width: 816px; height: 300px; overflow: auto;">
                <table class="highLightRow" cellpadding="3" cellspacing="0" border="1" width="800">
                    ...
                    <%	
							for (DiccionarioView d : diccionarios ){
								...
								out.print(
									...
									"<td>"+"<center>"+"<a href='DiccionarioList.jsp?eliminar=1&id="+d.getIdDiccionario()+"'onclick='return borrar()'" +">"+"<img id='Image2' src='img/delete.png' alt='Eliminar' border='0' />"+"</a>"+"</td>"+"</tr>"
									);
							}
						%>
                </table>
     ...
     <%if(divCrear=="1"){ %>
            <div id="divForm" style="margin-top: 20px">
                ...
                <table id="Table1" style="width: 500px; border: solid 1px #dfdfdf">
                    ...
                    <tr>
                        ...
                        <td>
                             <input name="tNombre" type="text" value="" style="width: 302px; "/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100px">
                        ...
                        <td>
                             <input name="tDescripcion" type="text" value="" style="width: 302px; "/>
                        </td>
                    </tr>
                    <tr>
                		<td></td>
                        <td>
                            <input type=submit value="Guardar" name="action" onclick="return ValidaCreacion('DiccionarioList');" />
                            <br />
                        </td>
                    </tr>
                </table>
            ...
            <% if(divEditar.equals("1")){ %>
            		...
            		<% DiccionarioView dicView  = sist.buscarDiccionarioViewByID(idDiccionario); %>
            		<div id="divForm" style="margin-top: 20px">
            			<table id="Table1" style="width: 500px; border: solid 1px #dfdfdf">
                    <tr>
                        <td colspan="2" style="background-color: #dfdfdf; font-weight: bold; height: 30px">
                    ...
                    <tr>
                        ...
                        <td>
                        	<input name="tNombre" type="text" value="<%=dicView.getNombre()%>" style="width: 302px; ">
                        </td>
                    </tr>
                    <tr>
                        <td width="100px">
                        ...
                        <td>
                        	<input name="tDescripcion" type="text" value="<%=dicView.getDescripcion()%>" style="width: 302px; ">
                        </td>
                    </tr>
                    <tr>
                		<td></td>
